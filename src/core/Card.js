...
const Card = ({ 
    ...
    const showViewButton = (shopViewProductButton) => {
        return (shopViewProductButton && (
    ...
    return (
        <div className="card">
            <div className="card-header name">{product.brand}</div>
            <div className="card-body">
                ...
                <br />
                {showViewButton(shopViewProductButton)}
